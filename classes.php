<?php
    ...
    /*
        -Osztály, objektum, konstruktor, destruktor
        -Tulajdonságok (public, private, protected)
        -Öröklődés (extends)
        -Trait (fgv-ek, amiket különböző osztáyból szeretnék elérni)
    */
    ...
    //Készítsünk egy ElectricCar osztályt, ami örökli a Car-t, és pluszban tartalmaz batteryCapacity tulajdonságot
    ...
    class ElectricCar extends Car
    {
        ...
        {
            parent::info();
            echo "Akkumlátorkapacitása: $this->batteryCapacity kWh.";
        }
    }
    ...
    //Traitek: Újrahasznosítható függvénytároló
